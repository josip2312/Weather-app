          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return _axios.default.get("http://api.openweathermap.org/data/2.5/weather?q=".concat(this.city, "&units=metric&appid=87d147bb9babc701d0563581a45f275a"));

              case 4:
                req = _context.sent;
                return _context.abrupt("return", Promise.resolve(req.data));
...
},{"axios":"node_modules/axios/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js"}],"js/ui.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = UIpaint;
//sucelje
var state = document.querySelector('.weather-state');
var loc = document.querySelector('.weather-city');
var temperature = document.querySelector('.weather-main-temperature');
var desc = document.querySelector('.weather-desc');
var image = document.querySelector('.weather-image');
var feelsLike = document.querySelector('.weather-feels_like');
...
function UIpaint(weather) {
  ...
  temperature.innerHTML = "".concat(weather.main.temp, " &deg; C");
  desc.textContent = weather.weather[0].description;
  image.setAttribute('src', "http://openweathermap.org/img/w/".concat(weather.weather[0].icon, ".png"));
  humidity.textContent = weather.main.humidity;
  pressure.textContent = weather.main.pressure;
  feelsLike.innerHTML = "".concat(weather.main.feels_like, " &deg; C");
}
...
var weather = new _weather.default('Mostar');
